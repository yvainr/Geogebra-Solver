...
def json_create():
    ...
    for line in lines:
        ...
        for point in line.points:
            if point.name == "Neo_update":
                line.points.remove(point)
                object['name'] = None
                object['type'] = 'neo_line'
    ...
    for angle in angles:
        ...
        if angle.size == "Neo_update":
            object['name'] = None
            object['type'] = 'neo_angle'
            object['points_on_object'] = None
    ...
    for segment in segments:
        ...
        if segment.size == "Neo_update":
            object['name'] = None
            object['type'] = 'neo_segment'
...
polygons_create(text2)
angles_create(text5)
angles_create(text8)
segments_create(text3)
segments_create(text4)
segments_create(text6)
segments_create(text7)
segments_create(text9)
